...
//    while(!SysCtlPeripheralReady(SYSCTL_PERIPH_GPIOC)); // Aguarda final da habilita��o
//    GPIOPinTypeGPIOOutput(GPIO_PORTC_BASE, GPIO_PIN_4); // PC4 como sa�da
//    GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_4, 0);
//    GPIOPinTypeGPIOOutput(GPIO_PORTC_BASE, GPIO_PIN_5); // PC5 como sa�da
//    GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_5, 0);
